      ...
      <div className="flex flex-col text-center items-center justify-center animate-fadeIn animation-delay-2 my-10 py-16 sm:py-32 md:py-48 md:flex-row md:space-x-4 md:text-left">
        ...
        <div className="md:mt-2 md:w-3/5">
          ...
          <p className="text-sm md:text-lg text-gray-600 dark:text-gray-300 mb-8">
            Building intelligent systems with CrewAI, AutoGen, and LangGraph. 
            Combining AI capabilities with modern web development to create 
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
            ...
            <Link
              href="/contact"  
              className="text-teal-600 font-semibold px-6 py-3 border-2 border-teal-600 rounded shadow hover:bg-teal-600 hover:text-white transition-colors"
            >
              Contact Me
            </Link>
          </div>
